...
class EmpFrame:
    def __init__(self):
        ...
        self.empmenu.add_cascade(label='Update Vechile List', command=lambda: vregistrationupdate.UpdatevRegistration())
        self.empmenu.add_cascade(label='Display Vechile List', command=lambda: vtreeview.ProductsList())
        ...
        self.empmenu.add_cascade(label='Car Sales', command=lambda: SALESCAR.Sales())
        ...
        self.btn1 = Button(self.my_frame, text="Logout", command=self.logout, background="light yellow",font=("georgia","15","bold"),
                           width=15).place(x=1000, y=50)
        self.btn2 = Button(self.my_frame, text="Change Password", command=changepassword.UpdatePassword, background="light yellow", font=("georgia","15","bold"),
                           width=15).place(x=1000, y=150)
        self.myimage13 = PhotoImage(file='C:\\Users\\ashvi\PycharmProjects\\automobile_management\\W.png')
        self.imagelabel23 = Label(self.my_frame, image=self.myimage13)
        self.imagelabel23.pack()
        self.myimage1 = PhotoImage(file='C:\\Users\\ashvi\PycharmProjects\\automobile_management\\k3.png')
